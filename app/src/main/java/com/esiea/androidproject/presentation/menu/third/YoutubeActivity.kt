package com.esiea.androidproject.presentation.menu.third
...
const val YOUTUBE_VIDEO_ID = "uR0sO8mYuVU"
...
class YoutubeActivity : YouTubeBaseActivity(), YouTubePlayer.OnInitializedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout = layoutInflater.inflate(R.layout.activity_third, null) as ConstraintLayout
